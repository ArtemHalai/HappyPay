...
<table class="w3-table-all w3-hoverable">
            ...
            <c:choose>
                                ...
                                <c:otherwise>
                                    <c:forEach items="${credit_request_admin}" var="request">
                                                    <tr>
                                       ...
                                       <a href="credit_request_admin?user_id=${request.userId}&decision=true&amount=${request.amount}" class="return" align="center" style="text-decoration: none;"><fmt:message
                                                                                        key="approve"/></a>
                                                             <a href="credit_request_admin?user_id=${request.userId}&decision=false&amount=${request.amount}" class="return" align="center" style="text-decoration: none;
