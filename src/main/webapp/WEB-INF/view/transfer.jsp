...
<fmt:setBundle basename="transfer"/>
<html lang="${language}">
...
<div class="main" style="height:55vh;">
    <p class="sign" align="center"><fmt:message key="transfer_sign"/></p>
<form class="request" method="post" action="transfer">
        <label for="amount">
                 <c:choose>
...
<label for="account_number">
                                 <c:choose>
                                                    <c:when test="${errors.account!=null}">
                                                       <fmt:message key="error.account_number"/>
                                                  </c:when>
                                                  <c:when test="${errors.account_number!=null}">
                                                                                                         <fmt:message key="error.account"/>
                                                                                                    </c:when>
                                                </c:choose>
                        </label>
                        <input class="uname" required name="account_number" type="number" align="center" placeholder=<fmt:message
                                key="account_number"/>>
