...
<div class="main">
    <p class="sign" align="center"><fmt:message key="limit_request"/></p>
<form class="request" method="post" action="limit_request">
        <label for="amount">
                 <c:choose>
                                    <c:when test="${errors.amount!=null}">
                                       <fmt:message key="error.amount"/>
                                  </c:when>
                                  <c:when test="${errors.credit!=null}">
                                                                         <fmt:message key="limit_already_requested"/>
                                                                    </c:when>
                                </c:choose>
        </label>
